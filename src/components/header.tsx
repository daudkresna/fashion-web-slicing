...
const Header = () => {
  ...
  return (
    <header className="relative flex p-4 md:px-16 md:py-8 items-center justify-between">
      ...
      <nav className="hidden md:flex md:flex-row">
        <ul className="flex gap-8 items-center group">
